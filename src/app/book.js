...
App = {
    ...
    buttonContent+=
        ...
        +'<p class="normal">IPFS编号：<samp id="ipfsaddress">'+result[6].slice(21)+'</samp></p>'
        ...
        +'<button onclick="window.location.href=\'library/manager/bookHome.html\'" style="background-color: #00bdef">返回主页</button>'
        +'</p>'
